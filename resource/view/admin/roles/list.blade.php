                ...
                <div class="col-md-12">
                    <div class="box grid-box">
                        ...
                        <div class="box-header with-border">
                            <div class="pull-right">
                                ...
                                <div class="btn-group pull-right grid-create-btn" style="margin-right: 10px">
                                    <a href="/admin/roles/create" class="btn btn-sm btn-success" title="新增">
                        ...
                        <div class="box-header with-border filter-box hide" id="filter-box">
                            <form action="/admin/roles" class="form-horizontal" method="get">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="box-body">
                            ...
                            <table class="table table-hover grid-table" id="grid-table64634d9f95d1e">
                                ...
                                @foreach($rolesList as $data)
                                    <tr data-key="{{$data['id']}}">
                                        ...
                                        <td>
                                            <a href="/admin/roles/edit/{{$data['id']}}"><i class="fa fa-edit"></i></a>
                        ...
                        <div class="box-footer clearfix">
                            ...
                            <ul class="pagination pagination-sm no-margin pull-right">
                                <li class="page-item @if($pageNo == 1) disabled @endif" >@if($pageNo > 1)<a class="page-link" href="/admin/roles?page={{$pageNo-1}}" rel="prev">&laquo;</a>@else <span class="page-link">&laquo;</span> @endif</li>
                                @for($i = 1; $i <= $totalPages; $i++)
                                    <li class="page-item @if($pageNo == $i) active @endif">@if($i != $pageNo)<a class="page-link" href="/admin/roles?page={{$i}}">{{$i}}</a>@else<span class="page-link">{{$i}}</span>@endif</li>
                                @endfor
                                <li class="page-item @if($pageNo ==$totalPages) disabled @endif">@if($pageNo != $totalPages)<a class="page-link" href="/admin/roles?page={{$totalPages}}"  rel="next">»</a>@else<span class="page-link">»</span>@endif</li>
                            </ul>
                        </div>
                    </div>
                </div>
